...
public class VentanaMejorado extends JFrame {
	...
	public VentanaMejorado(float valorConversion) {
		...
		mensaje.setBounds(10, 151, 207, 20);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				//decimos lo que es dolares pasandolo a string otra vez
